...
def main():
    ...
    print("⏳ Connecting to local Ollama service and pulling 'llama3.1:8b' (Large file, please wait)...")
    print("⏳ 正在連線本地 Ollama 服務並下載 llama3.1:8b 模型 (檔案較大，請耐心等候)...")
    
    ollama_cmd = ["ollama", "pull", "llama3.1:8b"]
    
    if run_command(ollama_cmd):
        print("✅ Llama 3.1 8B model is downloaded and ready!")
        print("✅ Llama 3.1 8B 大模型已成功下載並準備就緒！")
    else:
